<template>
  <div id="menu" :class="[store.menuToggle ? 'h-full' : 'h-0', 'bg-c-3']">
...
#menu {
  ...
  align-items: center;
  overflow: hidden;
  transition: all 1100ms var(--cubic-bezier);
...
.menu-item {
  ...
  transition: translate 400ms var(--cubic-bezier);
}
...
#menu-items:not(:hover) > .menu-item::after {
  width: 0%;
